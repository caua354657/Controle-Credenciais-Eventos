  ...
  <?php 
    echo '<div id="container-tabela">
            ...
            <div class="d-flex justify-content-between">
              <a href="cadastro_usuarios.php" class="btn btn-success">Novo</a>
    ...
    $sql = "select usuarios.id, usuarios.nome, usuarios.usuario, usuarios.categoria, empresas.razao_social as empresa from usuarios join empresas on empresas.id = usuarios.id_empresa";
      ...
      if($resultado->num_rows > 0)
      {
          ...
          while($linha = $resultado->fetch_assoc())
          {
              ...
              echo '<tr>
                      ...
                      <td>'.$linha['empresa'].'</td>
                      <td>
                          <a href="alterar_usuario.php?id='.$id.'" class="btn btn-outline-primary mt-2 mt-sm-0"><i class="bi bi-pencil-square"></i></a>
                          <a href="excluir_usuario.php?id='.$id.'" class="btn btn-outline-danger mt-2 mt-sm-0"><i class="bi bi-x-circle"></i></a>
                      </td>
                    </tr>';
          }
          echo '</tbody>
