...
<head>
    ...
    <link rel="stylesheet" href="css/excluir_cargos.css">
</head>
<body>
...
?>
    ...
    <form action="#" method="post">
        <div class="card bg-danger text-white">
            <div class="card-body text-center"><b>Excluir Cargo</b></div>
        </div>
        ...
        <?php
            ...
            {
                if(function_exists('excluir_cargo'))
                {
                    $resultado = excluir_cargo($id);

                    if($resultado === 'ja_associado') 
                    {
                        echo '<div class="alert alert-danger text-center mt-3">
                                <strong>Não é possível excluir este cargo porque existem pessoas associadas a ele.</strong>
                            </div>';
                    }
