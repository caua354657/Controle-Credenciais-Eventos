  ...
  <?php 
    echo '<div id="container-tabela">
            ...
            <div class="d-flex justify-content-between">
                <a href="cadastro_cargos.php" class="btn btn-success">Novo</a>
      ...
      if($resultado->num_rows > 0)
      {
          ...
          while($linha = $resultado->fetch_assoc())
          {
              ...
              echo '<tr>
                      ...
                      <td>'.$linha['nome'].'</td>
                      <td>
                          <a href="alterar_cargos.php?id='.$id.'" class="btn btn-outline-primary mt-2 mt-sm-0"><i class="bi bi-pencil-square"></i></a>
                          <a href="excluir_cargos.php?id='.$id.'" class="btn btn-outline-danger mt-2 mt-sm-0"><i class="bi bi-x-circle"></i></a>
                      </td>
                    </tr>';
          }
          echo '</tbody>
